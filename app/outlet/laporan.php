...
<main class="content">
	<div class="container-fluid p-0">
		<h1 class="h3 mb-4"><strong>Laporan</strong> <?= $u['cabang'] ?></h1>
		<div class="row">
			<div class="col-12 col-lg-8">
				<div class="card">
					<div class="card-header">
						<h5 class="card-title mb-0">Stok Masuk - Penerimaan</h5>
					</div>
					<div class="card-body">
							...
							<form action="" method="get">
								...
								<div class="col-6">
									...
									<div class="input-group">
										...
										<a href="../report/lapout_terima.php?tglawl=<?= $_GET['masukTglAwal'] ?>&tglahr=<?= $_GET['masukTglAhir'] ?>" target="_blank" class="btn btn-primary"><span data-feather="printer"></span></a>
								...
								<div class="row">
									<div class="col">
										...
										<div class="input-group">
											...
											<a href="../report/lapout_pakai.php?tgl=<?= $_GET['tglTerpakai'] ?>" target="_blank" class="btn btn-primary"><span data-feather="printer"></span></a>
										</div>
									</div>
								</div>
							</form>
			...
			<div class="col-12 col-lg-8">
				<div class="card">
					<div class="card-header">
						<h5 class="card-title mb-0">Stok Keluar - Penjualan</h5>
					</div>
					<div class="card-body">
						<div class="row d-flex">
							<form action="" method="get">
								<div class="row">
									...
									<div class="col-6">
										...
										<div class="input-group">
											...
											<a href="../report/lapout_keluar.php?tglawl=<?= $_GET['keluarTglAwal'] ?>&tglahr=<?= $_GET['keluarTglAhir'] ?>" target="_blank" class="btn btn-primary"><span data-feather="printer"></span></a>
											<!-- <a class="btn btn-primary"><span data-feather="download"></span></a> -->
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col">
										...
										<div class="input-group">
											...
											<a href="../report/lapout_buang.php?tgl=<?= $_GET['tglTerbuang'] ?>" target="_blank" class="btn btn-primary"><span data-feather="printer"></span></a>
										</div>
									</div>
								</div>
							</form>
