...
$pdf->Cell(0,0.7,'REKAP BARANG TERPAKAI',0,1,'C');
...
$no=1;
$pdf->SetFont('Arial','',8);
$keluar = myquery("SELECT terpakai.*, outlet.outlet as nama FROM terpakai LEFT JOIN outlet ON terpakai.outlet=outlet.kode WHERE tanggal='$tgl'");
